...
public class CoordinateFrameXGripper : MonoBehaviour
{
    ...
    private Vector3 hand_offset = new Vector3(0.0f, -0.105f, 0.0f);
    ...
    void Start()
    {
        ...
        hand = GameObject.Find("xarm_gripper_base_link");
    ...
    void Update()
    {
        ...
        if (isClicked)
        {
            ...
            if(isBimanual)
            {
                if (robot_arm == "xarm")
                {
                    SceneManager.LoadScene("X_GripperSelect_xarm");
                }
                else
                {
            ...
            else
            {
                if (robot_arm == "xarm")
                {
                    SceneManager.LoadScene("X_GripperCollection_xarm");
                }
                else
                {
